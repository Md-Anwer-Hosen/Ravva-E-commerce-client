...
import pant1 from "../assets/pant-r2457.jpeg";
...
const TopSelling = () => {
  ...
  return (
    <section className=" px-4 w-full mx-auto mb-25">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {productList.map((item) => (
          <div key={item.id} className="flex flex-col">
            <div className="bg-[#F0EEED] rounded-2xl overflow-hidden aspect-square border-1">
              <img
                src={item.img}
                alt={item.name}
      ...
      <div className="text-center mt-10">
        <button className="border border-gray-200 px-14 py-3 rounded-full font-medium  hover:text-white hover:bg-[#f68c1e] transition-all">
          View All
        </button>
      </div>
    </section>
